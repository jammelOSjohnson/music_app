  ...
  return (
    ...
    >
      <div className="relative w-full h-56 group">
        ...
        <img alt="sonf_img" src={song?.attributes?.artwork?.url} />
      </div>
      ...
      <div className="mt-4 flex flex-col">
        ...
        <p className="text-sm truncate text-gray-300 mt-1">
          <Link
            to={
              song?.attributes?.relationships?.artists
                ? `/catalog/dz/artists/${song?.attributes?.relationships?.artists?.data[0]?.id}`
                : "/top-artists"
            }
          >
